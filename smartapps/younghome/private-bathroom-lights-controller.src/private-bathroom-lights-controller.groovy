definition(
	name: "Private Bathroom Lights Controller",
	namespace: "younghome",
	author: "Benjamin J. Young",
	description: "Controls Private Bathroom Lights",
...
def lightsRed() {
	log.debug('Toning the lights red');
    
    lights.setColorTemperature(0);
    lights.setColor(hex: '#ff0000');
}

def lightsUnred() {
	log.debug('Toning the lights back to normal');
    
    lights.setColor(hex: '#000000');
    lights.setColorTemperature(0);
}